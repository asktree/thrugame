...
(function (root) {
  ...
  const EXAMPLES = [
    ...
    },
    {
      ...
      blurb: 'Water alone becomes salt, mors, vitae, salt — bonded in a chain. Three calcifiers and an animismus glyph feed a rocking wheel that drags the growing chain back and forth across a single bonder, then lays the finished compound around its own hub, where the product glyph waits. Five arms, one product every twenty ticks.',
      expect: { cycles: 217 },
      puzzle: {
        inputs: [
          { cell: [-3, 0], elem: 'Wa' }, { cell: [0, -4], elem: 'Wa' }, { cell: [5, -1], elem: 'Wa' },
        ],
        calcifiers: [[-1, -1], [1, -3], [4, -2]],
        animismus: [[[3, -1], [3, 0], [2, -2], [2, -3]]],
        bonders: [[[0, -1], [1, -1]]],
        output: {
      ...
      machine: {
        arms: [
          { id: 'W', grippers: 1, len: 1, mount: { ground: [0, 0] }, angle: 3,
            tape: { delay: 20, ops: ['G','+','-','W','W','W','-','W','W','W','W','W','W','W','-','-','D','+','+','+'] } },
          { id: 'H', grippers: 1, len: 1, mount: { ground: [-2, 0] }, angle: 3,
            tape: { delay: 15, ops: ['G','+','+','+','D','-','-','-','W','W','W','W','W','W','W','W','W','W','W','W'] } },
          { id: 'N', grippers: 1, len: 1, mount: { ground: [0, -3] }, angle: 4,
            tape: { delay: 23, ops: ['G','+','+','D','-','-','W','W','W','W','W','W','W','W','W','W','W','W','W','W'] } },
          { id: 'P', grippers: 1, len: 1, mount: { ground: [4, -1] }, angle: 0,
            tape: { ops: ['G','-','-','D','G','-','-','D','-','-','G','-','-','D','G','-','D','-','-','-'] } },
          { id: 'F', grippers: 1, len: 1, mount: { ground: [1, -2] }, angle: 5,
            tape: { delay: 17, ops: ['G','-','-','-','-','D','-','G','+','D','+','+','+','G','+','+','+','D','-','-'] } },
        ],
      },
    },
    {
